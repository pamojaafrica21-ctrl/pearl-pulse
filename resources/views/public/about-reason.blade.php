...
<section class="bg-cream pt-16 pb-20">
    <div class="mx-auto max-w-3xl px-5 lg:px-8">
        <p class="text-xs tracking-[0.22em] uppercase text-gold mb-3">Travel with a reason</p>
        <h1 class="font-display text-5xl md:text-6xl text-forest">Conservation, community, local people</h1>
