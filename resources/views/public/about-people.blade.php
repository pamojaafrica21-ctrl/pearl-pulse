...
<section class="bg-cream pt-16 pb-16">
    <div class="mx-auto max-w-7xl px-5 lg:px-8">
        <p class="text-xs tracking-[0.22em] uppercase text-gold mb-3">Our people</p>
        <h1 class="font-display text-5xl md:text-6xl text-forest">Your journey. Our people.</h1>
    ...
    <div class="mx-auto max-w-7xl px-5 lg:px-8 grid gap-12 sm:grid-cols-2 lg:grid-cols-3">
        @foreach($team as $member)
            <div>
                ...
                @endif
                <h2 class="font-display text-3xl text-forest mt-5">{{ $member->name }}</h2>
                <p class="text-sm text-gold mt-1">{{ $member->role }}</p>
